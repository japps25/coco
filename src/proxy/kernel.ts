...
export namespace Kernel {
   ...
   */
  export function findById(id: string, options?: IOptions): Promise<IModel> {
   ...
   */
  export function connectTo(id: string, options?: Kernel.IOptions): Promise<IKernel> {
   ...
   */
  export interface IOptions extends JSONObject {
    /**
   ...
   */
  export type Status = "unknown" | "starting" | "reconnecting" | "idle" | "busy" | "restarting" | "dead";
