...
export namespace nbformat {
   ...
   */
  export const MINOR_VERSION: number = 1;
   ...
   */
  export function validateMimeValue(type: string, value: MultilineString | JSONObject): boolean {
   ...
   * A cell union type.
   */
  export type ICell = IRawCell | IMarkdownCell | ICodeCell;
   ...
   */
  export type IOutput = IExecuteResult | IDisplayData | IStream | IError;
}
