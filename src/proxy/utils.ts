 ...
 */
export function copy(object: JSONObject): JSONObject {
 ...
 */
export function urlEncodeParts(uri: string): string {
 ...
 */
export function jsonToQueryString(json: JSONObject): string {
  return (
    "?" +
    Object.keys(json)
 ...
 */
export function ajaxRequest(url: string, ajaxSettings: IAjaxSettings): Promise<IAjaxSuccess> {
 ...
 */
export function makeAjaxError(success: IAjaxSuccess, throwError?: string): IAjaxError {
  let xhr = success.xhr;
 ...
 */
export function loadObject(name: string, moduleName: string, registry?: { [key: string]: any }): Promise<any> {
  return new Promise((resolve, reject) => {
 ...
 */
export function getConfigOption(name: string): string {
  if (configData) {
 ...
 */
export function ajaxSettingsWithToken(ajaxSettings?: IAjaxSettings, token?: string): IAjaxSettings {
  if (!ajaxSettings) {
    ajaxSettings = {};
  } else {
